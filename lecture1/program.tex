...
\begin{figure}
	...
	\subfigure[\scriptsize{Charles Babbage}]
	{\includegraphics[width=0.27\linewidth]{figs/babbage.jpg}}
	\hspace{0.15in}
	\subfigure[\scriptsize{Ada Lovelace}]
	{\includegraphics[width=0.25\linewidth]{figs/ada.png}}
\end{figure}
\begin{itemize}
	\item {Ada is the first programmer}
	\item {A language is named after her to memorize her contribution}
	\item {\textcolor{blue}{Share the story about Charles Babbage and Ada Lovelace ...}}
\end{itemize}
\end{frame}
...
\begin{figure}
	\includegraphics[width=0.35\linewidth]{figs/difference_engine.jpg}
	\caption{The difference machine}
\end{figure}
\begin{itemize}
	\item {Ada wrote the programs for the difference machine}
\end{itemize}
\end{frame}

\begin{frame}
	\frametitle{Why programming? (3)}
	\begin{figure}
...
\begin{figure}
	\includegraphics[width=0.75\linewidth]{figs/talk2pc.jpg}
\end{figure}
\begin{itemize}
