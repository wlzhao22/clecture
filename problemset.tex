...
\begin{enumerate}
    \item Given a user input of three integers \textbf{year}, \textbf{month}, and \textbf{day}, output this day is which day of the year. Do it with \textcolor{blue}{switch} clause.
\end{enumerate}
