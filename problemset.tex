...
\title{C Programming --- Problem Set}
...
\begin{enumerate}
    ...
    \item Calculate the frequency of characters in a string (case-insensitive). List the frequencies of each appearing character.
...
\begin{enumerate}
    \item Build a single-directed list structure, no longer than 26. The length is specified by the user. Values are uppercase characters (e.g., $A{\rightarrow}B{\rightarrow}C{\rightarrow}D{\rightarrow}NIL$). Reverse the list and print it out.
